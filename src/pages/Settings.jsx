    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="bg-bg-secondary rounded-xl border border-border p-5 flex gap-5">
          ...
          {/* Custom */}
          <div className="shrink-0 flex flex-col items-center gap-3 min-w-[100px]">
            ...
            >
              ...
              <span className="text-[11px] font-medium text-text-primary">Apply</span>
            </button>
            <div className="flex items-center gap-2">
              <div className="flex flex-col items-center gap-1">
                <label className="text-[9px] text-text-muted">Accent</label>
                <input
                  type="color"
              ...
              <div className="flex flex-col items-center gap-1">
                <label className="text-[9px] text-text-muted">Base</label>
                <input
                  type="color"
                  value={customConfig.baseColor || '#101012'}
                  onChange={e => {
                    setCustomConfig({ ...customConfig, baseColor: e.target.value });
                    setTheme('custom');
                  }}
                  className="w-8 h-8 rounded-lg border border-border cursor-pointer bg-transparent"
                />
